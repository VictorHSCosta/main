        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              <h3 className="text-lg font-semibold text-gray-900">MyApp</h3>
              <p className="mt-2 text-gray-600">
                Criando experiências digitais incríveis com as melhores tecnologias.
              </p>
            </div>
            <div>
              <h4 className="text-sm font-semibold text-gray-900 tracking-wider uppercase">Product</h4>
